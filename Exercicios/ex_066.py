...
pedinte["Rendimento"] = float(input('Qual é o seu rendimento mensal?\n--> '))
pedinte["Despesa"] = float(input('E quais são as suas despesas mensais?\n--> '))
pedinte["RendaLiquida"] = pedinte["Rendimento"] - pedinte["Despesa"]
pedinte["Credito"] = float(input('Qual é o valor do seu crédito?\n--> '))
